package com.example.studyplatform.pages
...
import com.varabyte.kobweb.silk.components.icons.fa.FaUserSecret
...
import org.jetbrains.compose.web.dom.Button as Button

private fun Modifier.color(unit: Unit, any: Any?): Any {
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            P(
                ...
                Text(value = "Приветствуем Вас в нашей онлайн школе, $name")
            }
        }
        Input(
            type = InputType.Text,
            attrs = InputStyle.toModifier()
                ...
                .toAttrs{
                    placeholder(value = "Введите своё имя")
                    onInput {
                        name = it.value
                    }
                }
